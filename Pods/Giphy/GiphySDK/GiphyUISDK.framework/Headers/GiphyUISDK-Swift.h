...
typedef SWIFT_ENUM(NSInteger, GPHSearchBarType, open) {
  GPHSearchBarTypeSquare = 0,
  GPHSearchBarTypeRound = 1,
};
...
@property (nonatomic, readonly) enum GPHSearchBarType searchBarType;
...
@property (nonatomic, readonly, strong) UIFont * _Nullable mediaButtonFont;
...
@property (nonatomic, readonly, strong) UIColor * _Nonnull confirmationScreenBackgroundColor;
...
@property (nonatomic, readonly, strong) UIColor * _Nonnull toolBarSwitchSelectedColor;
...
SWIFT_CLASS("_TtC10GiphyUISDK10GPHToolBar")
@interface GPHToolBar : UIView
- (nonnull instancetype)initWithFrame:(CGRect)frame SWIFT_UNAVAILABLE;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder SWIFT_UNAVAILABLE;
@end
...
@interface GiphySearchController (SWIFT_EXTENSION(GiphyUISDK))
- (void)selectedMediaTypeDidChange:(enum GPHMediaType)mediaType;
- (void)selectedContentDidChange:(GPHContent * _Nonnull)content;
@end
...
@interface GiphySearchController (SWIFT_EXTENSION(GiphyUISDK))
- (BOOL)shouldUnfocusOnSearchPress SWIFT_WARN_UNUSED_RESULT;
- (void)searchBarFocusDidChange:(GPHSearchBar * _Nonnull)searchBarView focused:(BOOL)focused text:(NSString * _Nonnull)text;
- (void)searchBarDidRequestSearch:(GPHSearchBar * _Nonnull)searchBarView query:(NSString * _Nonnull)query;
- (void)backButtonTapped:(GPHSearchBar * _Nonnull)searchBarView;
@end
